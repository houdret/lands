<?php
    ...
    {
        session_destroy();
        header('Location: ../../site_futur/vue/index.php');
        exit();
    }
    
    $db = new PDO('mysql:host=localhost;dbname=jilou2010_db1', 'root', '');
            ...
            else
            {
                ...
                switch ($retour)
                {
                    ...
                    case Personnage::PERSONNAGE_FRAPPE :
                        $message = 'Le personnage a bien été frappé !<img src="blesse.png" alt="blesse"/>';
                    ...
                    case Personnage::PERSONNAGE_TUE :
                        $message = 'Vous avez tué ce personnage ! <img src="mort.png"/>';
...
<?php
    ...
    {
?>
        <p><a href="?deconnexion=1"><img src="boutonPousser.png" border="0"
		onMouseover="this.src='boutonRelacher.png'"
		onMouseout="this.src='boutonPousser.png'"></a></p>
